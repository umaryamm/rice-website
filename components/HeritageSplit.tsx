    ...
    <section className="max-w-[1400px] mx-auto px-6 md:px-12 py-24 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
      ...
      <FadeIn delay={0.2} className="order-1 md:order-2">
        ...
        <p className="text-sm text-primary-container/70 mb-8 leading-relaxed">
          From heirloom seed lines preserved across generations to a commitment
          to sustainable cultivation, our heritage isn&apos;t a marketing story
          — it&apos;s how we still work today.
        </p>
