  ...
  return (
    <section className="max-w-[1400px] mx-auto px-6 md:px-12 py-24">
      <FadeIn className="text-center mb-16 max-w-2xl mx-auto">
        ...
        <h2 className="font-serif text-3xl md:text-4xl text-primary-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {paths.map((path, i) => (
          ...
          >
            ...
            <h3 className="font-serif text-xl text-primary-container mb-3">
              {path.title}
            </h3>

            <p className="text-sm text-primary-container/70 mb-8 leading-relaxed flex-1">
              {path.desc}
            </p>
