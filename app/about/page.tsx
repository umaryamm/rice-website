...
const processSteps = [
  {
    ...
    desc: "We employ rigorous crop rotation and organic composting to maintain optimal soil biome health, ensuring nutrient-dense cultivation without synthetic fertilizers.",
    img: "/images/soil-stewardship.png",
    alt: "Dark, nutrient-rich soil being turned by hand",
  },
  {
    phase: "Phase 02",
    title: "Optical Sorting",
    desc: "Post-harvest, grains undergo laser-guided optical sorting. Only grains meeting exact dimensional and color tolerances proceed to the final milling stage.",
    img: "/images/optical-sorting.png",
    alt: "Optical sorting machinery in a modern milling facility",
  },
  {
    phase: "Phase 03",
    title: "Artisanal Milling",
    desc: "A slow-friction milling process preserves the structural integrity and essential oils of the grain, resulting in a superior polish and enhanced cooking properties.",
    img: "/images/artisanal-milling.png",
    alt: "Perfectly milled white rice grains on linen",
  },
];
      ...
      <main className="bg-background pt-[88px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 min-h-[500px] md:min-h-[716px]">
            <FadeIn className="flex flex-col justify-center py-16 order-2 md:order-1">
              ...
              <p className="font-body-md text-primary-container/70 max-w-md">
                We view agriculture not as an industry, but as an artisanal
                practice passed down through generations. Our commitment to
                heritage strains yields a product of unmatched culinary
                fidelity.
              </p>
            </FadeIn>
        ...
        <section className="max-w-[1400px] mx-auto px-6 md:px-12 mb-24">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            >
              <h2 className="font-headline-sm text-primary-container mb-6">
                The Lineage of Flavor.
              </h2>

              <p className="font-technical-data text-primary-container/70 mb-6">
                Our story begins in the fertile valleys where the first
                heirloom grains were sown. We have painstakingly preserved
                these original seed lines, resisting the industrial urge to
                hybridize for yield over quality.
              </p>

              <p className="font-technical-data text-primary-container/70">
                Each harvest is a continuation of a century-old dialogue
                between the soil, the climate, and our master cultivators —
                resulting in a grain with a complex aromatic profile modern
                commercial varieties can&apos;t replicate.
              </p>
            </FadeIn>
          </div>
        </section>
        ...
        <section className="bg-surface-container-highest/10 py-24">
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <FadeIn className="text-center mb-24 max-w-2xl mx-auto">
              <span className="text-xs uppercase tracking-widest text-accent-gold mb-4 block">
                The Methodology
              </span>

              <h2 className="font-headline-md text-primary-container">
              ...
              {processSteps.map((step, i) => (
                ...
                >
                  ...
                  <div className="border-t border-surface-container-highest/50 pt-6 group-hover:border-accent-gold transition-colors duration-500">
                    <span className="text-xs text-accent-gold mb-2 block">
                      {step.phase}
                    </span>
